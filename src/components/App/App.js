...
function App() {
  return (
    ...
    <div className="sidebar-nav">
        ...
        <h2 className="text-center hidden-xs"><a href="https://socialyte.codeplus.it/personal-profile.html" title="Profile">My User</a></h2>
    ...
    <div className="content-posts profile-content">
        ...
        <ul className="nav nav-tabs" role="tablist">
            <li className="active"><a href="https://socialyte.codeplus.it/personal-profile.html#posts" role="tab" id="postsTab" data-toggle="tab" aria-controls="posts" aria-expanded="true">Last posts</a></li>
            <li className=""><a href="https://socialyte.codeplus.it/personal-profile.html#profile" role="tab" id="profileTab" data-toggle="tab" aria-controls="profile" aria-expanded="false">Profile</a></li>
            <li className=""><a href="https://socialyte.codeplus.it/personal-profile.html#chat" role="tab" id="chatTab" data-toggle="tab" aria-controls="chat" aria-expanded="false">Chat</a></li>
        </ul>
